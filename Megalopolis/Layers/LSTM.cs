...
namespace Megalopolis
{
    namespace Layers
    {
        ...
        public class LSTM : Layer, IUpdatable
        {
            ...
            public LSTM(int inputs, int outputs, Func<int, int, int, double> func) : base(inputs, outputs)
            {
            ...
            public LSTM(Layer layer, int nodes, Func<int, int, int, double> func) : base(layer, nodes)
            {
                var length1 = outputs * 4;
            ...
            public LSTM(int nodes, Func<int, int, int, double> func, Layer layer) : base(nodes, layer)
            {
                var length1 = outputs * 4;
